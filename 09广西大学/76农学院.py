...
school_id = 9
college_id = 76
base_url = 'https://prof.gxu.edu.cn/backend/openapi/openSearch/findByCondition?dwlx=2&dwh=33100&xm=&xkml=&yjxk=&dslx=&firstLetter=&pageNum={pagenum}&pageSize=12'
start_urls = [base_url.format(pagenum=pagenum+1) for pagenum in range(14)]
