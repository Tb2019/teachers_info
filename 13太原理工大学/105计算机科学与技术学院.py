...
college_id = 105
start_urls = [
                'https://ccst.tyut.edu.cn/szdw/js.htm',
                'https://ccst.tyut.edu.cn/szdw/js/1.htm',
                'https://ccst.tyut.edu.cn/szdw/fjs.htm',
                'https://ccst.tyut.edu.cn/szdw/fjs/2.htm',
                'https://ccst.tyut.edu.cn/szdw/fjs/1.htm',
                'https://ccst.tyut.edu.cn/szdw/js1.htm',
                'https://ccst.tyut.edu.cn/szdw/js1/4.htm',
                'https://ccst.tyut.edu.cn/szdw/js1/3.htm',
                'https://ccst.tyut.edu.cn/szdw/js1/2.htm',
                'https://ccst.tyut.edu.cn/szdw/js1/1.htm',
                'https://ccst.tyut.edu.cn/szdw/bssds.htm',
                'https://ccst.tyut.edu.cn/szdw/sssds.htm',
                'https://ccst.tyut.edu.cn/szdw/sssds/4.htm',
                'https://ccst.tyut.edu.cn/szdw/sssds/3.htm',
                'https://ccst.tyut.edu.cn/szdw/sssds/2.htm',
                'https://ccst.tyut.edu.cn/szdw/sssds/1.htm'
              ]

a_s_xpath_str = '//ul[@class="main_content_content_shizi"]//a[@href!="#"]'
...
class SpecialSpider(ReCrawler):
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./div[@class="shizi_info"]/div[@class="shizi_info_main"]//text()')
            # print(name)
            try:
                directions = ''.join(a.xpath('./div[@class="shizi_info"]/div[@class="shizi_info_main_b"]//text()'))
            ...
            if name:
                ...
                continue
            yield name, link, directions

    def get_detail_page(self, index_result):
        loop = asyncio.get_event_loop()
        session = aiohttp.ClientSession()
        tasks = [get_response_async(url, session, name=name, directions=directions) for name, url, directions in index_result if len(name) >= 2]
    ...
    def parse_detail(self, detail_page, url):
        if detail_page:
            ...
            try:
                ...
                try:
                    email = re.findall(r'(?<=邮箱：)[0-9a-zA-Z()._,\s\[\]]+', all_content, re.S)[0]
                    email = re.sub(r'(?:\(at\)|\(AT\)|\[at]|\[AT])', '@', email)
