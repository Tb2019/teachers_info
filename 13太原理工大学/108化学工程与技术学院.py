...
school_name = '太原理工大学'
college_name = '化学工程与技术'
school_id = 13
college_id = 108
start_urls = [
                'https://ccet.tyut.edu.cn/szdw/jsml.htm'
              ]

a_s_xpath_str = '//div[@class="erji_info1"]/div[@class="js_all"]/div[@class="js_list"]//a[@href!="#"]'
target_div_xpath_str = '//div[@class="js_show"]'
# # 研究方向
...
class SpecialSpider(ReCrawler):
    def parse_detail(self, detail_page, url):
        if detail_page:
            ...
            full_src = None
            try:
                src = target_div.xpath('.//img[contains(@src, "local")]/@src')[0]
