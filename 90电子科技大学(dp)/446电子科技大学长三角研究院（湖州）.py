...
school_name = '电子科技大学'
college_name = '电子科技大学长三角研究院（湖州）'
school_id = 90
college_id = 446
img_url_head = None
partition_num = '028'
start_urls = [
                'http://csj.uestc.edu.cn/szdw/jsml/thzjsjwxtxyjzx.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/xclynykxyjzx.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/jcdlyxtyjzx.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/gyzlwjznzzyjzx.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/wxdhjygyjzx.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/rgznjggaqyjzx.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/swyxyxxjssys.htm',
                'http://csj.uestc.edu.cn/szdw/jsml/wgsys.htm',
              ]

a_s_xpath_str = '//ul[@class="name-list container-fluid"]//a'
