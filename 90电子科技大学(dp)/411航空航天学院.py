...
partition_num = '028'
start_urls = [
                'https://www.iaa.uestc.edu.cn/szdw/jsml/azc/js.htm',
                'https://www.iaa.uestc.edu.cn/szdw/jsml/azc/fjs.htm',
                'https://www.iaa.uestc.edu.cn/szdw/jsml/azc/yjy.htm',
                'https://www.iaa.uestc.edu.cn/szdw/jsml/azc/fyjy.htm',
                'https://www.iaa.uestc.edu.cn/szdw/jsml/azc/gjgcs.htm',
                'https://www.iaa.uestc.edu.cn/szdw/jsml/azc/jsjyx.htm'
              ]

a_s_xpath_str = '//div[@class="teachers_box"]//a'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="base_info"]/div[1]/text()')
            if name:
                name = ''.join(name)
