...
school_name = '电子科技大学'
college_name = '信息与软件工程学院（示范性软件学院）'
school_id = 90
college_id = 410
img_url_head = None
partition_num = '028'
start_urls = [
                'https://sise.uestc.edu.cn/xygk/szdwq/js.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/js/2.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/js/1.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/fjs.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/fjs/4.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/fjs/3.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/fjs/2.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/fjs/1.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/js_zlyjy_gcs.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/js_zlyjy_gcs/2.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/js_zlyjy_gcs/3.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/zjzl.htm',
                'https://sise.uestc.edu.cn/xygk/szdwq/gl.htm',
              ]

a_s_xpath_str = '//div[@class="row"]//a'
target_div_xpath_str = '//div[@class="list-content content-card"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//span[@class="teacher-name"]/text()')
            if name:
                name = ''.join(name)
