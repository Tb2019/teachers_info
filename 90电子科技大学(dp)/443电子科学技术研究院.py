...
school_name = '电子科技大学'
college_name = '电子科学技术研究院'
school_id = 90
college_id = 443
img_url_head = None
partition_num = '028'
start_urls = [
                'https://www.riest.uestc.edu.cn/szdw/jsml1/js_yjyd_.htm',
                'https://www.riest.uestc.edu.cn/szdw/jsml1/fjs_fyjyd_.htm',
                'https://www.riest.uestc.edu.cn/szdw/jsml1/js_gcsjyx_.htm'
              ]

a_s_xpath_str = '//ul[@class="jsml_01 clearfloat"]//a'
