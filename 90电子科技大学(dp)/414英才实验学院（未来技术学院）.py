...
school_name = '电子科技大学'
college_name = '英才实验学院（未来技术学院）'
school_id = 90
college_id = 414
img_url_head = None
partition_num = '028'
start_urls = ['https://www.yingcai.uestc.edu.cn/szdw/jsml.htm'] + [f'https://www.yingcai.uestc.edu.cn/szdw/jsml/{i}.htm' for i in range(1, 17)]

a_s_xpath_str = '//div[@class="teachers"]/div[@class="teacheritem"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//p[@class="name"]/text()')
            if name:
                name = ''.join(name)
