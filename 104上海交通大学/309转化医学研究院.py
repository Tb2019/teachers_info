...
school_name = '上海交通大学'
college_name = '转化医学研究院'
school_id = 104
college_id = 309
img_url_head = None
partition_num = '021'
start_urls = [
                'https://transmed.sjtu.edu.cn/talent?type=sskxj'
              ]

a_s_xpath_str = ''
target_div_xpath_str = '//div[@class="talent-main-right"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        url = "https://transmed-data.sjtu.edu.cn/talent/simpleList?type=sskxj&firstChar=undefined&name=undefined"
        ...
        headers = {
            ...
            'DNT': '1',
            'Origin': 'https://transmed.sjtu.edu.cn',
            'Pragma': 'no-cache',
            'Referer': 'https://transmed.sjtu.edu.cn/',
        ...
        for item in response:
            name = item['title']
            link = f'https://transmed.sjtu.edu.cn/talent/detail?type=talent&id={item["talentId"]}'
            yield name, link
