...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-电子工程系'
school_id = 104
college_id = 162
img_url_head = None
partition_num = '021'
start_urls = [
                ...
                'https://ee.sjtu.edu.cn/Faculty.aspx?infolb=74&flag=66&JC=100',

              ]


a_s_xpath_str = '//div[@id="divjsname"]//div[@class="all"]//li//dd/a'


target_div_xpath_str = '//div[@class="paging_content"]'
