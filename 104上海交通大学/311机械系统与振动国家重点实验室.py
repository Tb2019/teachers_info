...
school_name = '上海交通大学'
college_name = '机械系统与振动国家重点实验室'
school_id = 104
college_id = 311
img_url_head = None
partition_num = '021'
start_urls = [
                'https://msv.sjtu.edu.cn/Teacher/rencai.aspx?cid=21'
              ]

# a_s_xpath_str = '/html/body/form/div[7]/div/div/div/div/div/div/div//a'
a_s_xpath_str = "//a[@id='dlPicList_HyperLink2_72']"
