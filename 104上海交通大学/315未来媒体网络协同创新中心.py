...
school_name = '上海交通大学'
college_name = '未来媒体网络协同创新中心'
school_id = 104
college_id = 315
img_url_head = None
partition_num = '021'
start_urls = [
                'https://cmic.sjtu.edu.cn/CN/teacher.aspx?info_lb=35&flag=4'
              ]

a_s_xpath_str = '//div[@class="lb"]//tr/td//tr[2]//a'
target_div_xpath_str = '//div[@class="jj_nr"]'
