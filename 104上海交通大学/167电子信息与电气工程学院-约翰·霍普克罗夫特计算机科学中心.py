...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-约翰·霍普克罗夫特计算机科学中心'
school_id = 104
college_id = 167
img_url_head = None
partition_num = '021'
start_urls = [
                'https://jhc.sjtu.edu.cn/people/members/',
              ]

a_s_xpath_str = '//section[@class="bg-catskill section-20 section-md-30"]//div[@class="range text-md-left offset-top-30"]//a'
