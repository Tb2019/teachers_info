...
school_name = '上海交通大学'
college_name = '巴黎卓越工程师学院'
school_id = 104
college_id = 278
img_url_head = None
partition_num = '021'
start_urls = [
                'https://speit.sjtu.edu.cn/faculty/speit_professors'
              ]

a_s_xpath_str = '//div[@id="keywordBox"]/div/a'
target_div_xpath_str = '//div[@class="people-detail"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="name fnt24"]/text()')
            if name:
                name = ''.join(name)
