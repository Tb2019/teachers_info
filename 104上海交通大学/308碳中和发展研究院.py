...
school_name = '上海交通大学'
college_name = '碳中和发展研究院'
school_id = 104
college_id = 308
img_url_head = None
partition_num = '021'
start_urls = [
                'https://ricn.sjtu.edu.cn/Web/TeacherTwo/2',
              ]

a_s_xpath_str = '//*[@id="ALL"]/div/div[2]/ul/li/a'
target_div_xpath_str = '//div[@class="pMainCon"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="h3"]/text()')
            if name:
                name = ''.join(name)
...
spider = SpecialSpider(
                   ...
                   school_id=school_id,
                   college_id=college_id,
                   name_filter_re=r'(?:副|助理|讲席)?(教授|研究员|主任|博士|中国|讲师).*?$',
