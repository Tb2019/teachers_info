...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-自动化系系'
school_id = 104
college_id = 160
img_url_head = None
partition_num = '021'
start_urls = [
                'https://automation.sjtu.edu.cn/facultylist',
              ]

a_s_xpath_str = '//div[@id="divresultletter"]/ul[@class="clearfix"]//a'

target_div_xpath_str = '//div[@class="pd"]'
