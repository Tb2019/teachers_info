...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-清源研究院'
school_id = 104
college_id = 169
img_url_head = None
partition_num = '021'
start_urls = [
                'http://www.qingyuan.sjtu.edu.cn/c/quanzhijiaoshi.html',
              ]

a_s_xpath_str = '//div[@class="tech_position"]//div[@class="item"]//a'
target_div_xpath_str = '//div[@class="teaher_detail"]'
