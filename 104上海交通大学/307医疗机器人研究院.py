...
school_name = '上海交通大学'
college_name = '医疗机器人研究院'
school_id = 104
college_id = 307
img_url_head = None
partition_num = '021'
start_urls = [
                'https://imr.sjtu.edu.cn/sz_teachers.html'
              ]

a_s_xpath_str = '//*[@id="show_list"]/li/a'
target_div_xpath_str = '//div[@class="d2"]'
...
spider = ReCrawler(
                   ...
                   school_id=school_id,
                   college_id=college_id,
                   name_filter_re=r'(?:副|助理)?(教授|研究员|主任|博士).*?$',
