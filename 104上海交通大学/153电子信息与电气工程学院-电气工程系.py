...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-电气工程系'
school_id = 104
college_id = 153
img_url_head = None
partition_num = '021'
start_urls = [
                'https://eei.sjtu.edu.cn/faculty.php?cid=104102',
              ]

a_s_xpath_str = '//div[@class="teacher-team-list"]//a'

target_div_xpath_str = '//div[@class="container"]'
