...
partition_num = '021'
start_urls = [
                'https://ins.sjtu.edu.cn/faculty'
              ]

a_s_xpath_str = ''
target_div_xpath_str = '//div[@class="page  "]|//main[@class="page-content"]|//body'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        headers = {
            ...
            'DNT': '1',
            'Pragma': 'no-cache',
            'Referer': 'https://ins.sjtu.edu.cn/faculty',
        ...
        for cat_id in ['88', '30', '31', '89', '36']:
            url = f"https://ins.sjtu.edu.cn/api/ins/peoples.json?&page=1&category_id={cat_id}"
            ...
            for i in data:
                for item in i['records']:
                    ...
                    if item['homepage']:
                        ...
                        eng_name = item['name_py']
                        link = 'https://ins.sjtu.edu.cn/peoples/' + f'{eng_name}'
                    yield name, link
