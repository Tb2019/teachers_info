...
school_name = '上海交通大学'
college_name = '细胞分化与凋亡教育部重点实验室'
school_id = 104
college_id = 316
img_url_head = None
partition_num = '021'
start_urls = [
                'https://cda.shsmu.edu.cn/yjdw/xsgg.htm',
                'https://cda.shsmu.edu.cn/yjdw/xsgg/2.htm',
                'https://cda.shsmu.edu.cn/yjdw/xsgg/1.htm',
              ]

a_s_xpath_str = '//div[@class="jj_nr"]//tbody/tr/td[2]'
