...
school_name = '上海交通大学'
college_name = '区域光纤通信网与新型光通信系统国家重点实验室'
school_id = 104
college_id = 313
img_url_head = None
partition_num = '021'
start_urls = [
                'https://loct.sjtu.edu.cn/team/default.aspx?cid=12',
              ]

a_s_xpath_str = '//ul[@class="list"]/li/div/a'
target_div_xpath_str = '//div[@class="pageContent"]'
        ...
        for a in a_s:
            ...
            if name:
                ...
                try:
                    ...
                    # if link in ('#',):
                    #     continue
                    link = f'https://loct.sjtu.edu.cn/team/detail.aspx?cid=12&id={oid}'
                except:
                    continue
            else:
