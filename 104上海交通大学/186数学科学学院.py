...
partition_num = '021'
start_urls = [
                'https://math.sjtu.edu.cn/Default/teacherlist/'
              ]

a_s_xpath_str = '//div[@class="teacher-list-name"]//li/a'
target_div_xpath_str = '//div[@class="page-show"]'
