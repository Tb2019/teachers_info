...
school_name = '上海交通大学'
college_name = '董浩云航运与物流研究院（中美物流研究院）'
school_id = 104
college_id = 310
img_url_head = None
partition_num = '021'
start_urls = [
                'http://www.sugli.sjtu.edu.cn/teacher1.html',
              ]

a_s_xpath_str = '//ul[@class="ml_lb"]/li/a'
target_div_xpath_str = '//div[contains(@class, "jss")]|//div[@id="main"]/div[@class="container "][2]'
