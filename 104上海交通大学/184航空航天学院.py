...
img_url_head = None
partition_num = '021'
start_urls = ['https://www.aero.sjtu.edu.cn/Data/List/szdw?page=1&str=All'] + [f'https://www.aero.sjtu.edu.cn/Data/List/szdw?str=All&page={i}' for i in range(2, 10)]

a_s_xpath_str = '/html/body/div[1]/div[3]/div/div/div[2]/div[3]/ul/li/div[2]/p/a'
target_div_xpath_str = '//div[@class="view-cnt"]'
