...
school_name = '上海交通大学'
college_name = '系统生物医学研究院'
school_id = 104
college_id = 279
img_url_head = None
partition_num = '021'
start_urls = [
                'https://scsb.sjtu.edu.cn/Professor.html',
                'https://scsb.sjtu.edu.cn/Researcher.html',
                'https://scsb.sjtu.edu.cn/AssociateResearcher.html',
                'https://scsb.sjtu.edu.cn/AssistantResearchFellow.html',
                'https://scsb.sjtu.edu.cn/AuxiliaryStaff.html'
              ]

a_s_xpath_str = '//div[@class="ml_lb"]/ul/li/a'
target_div_xpath_str = '//div[@class="main"]'
