...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-微纳电子学系'
school_id = 104
college_id = 164
img_url_head = None
partition_num = '021'
start_urls = [
                'https://dmne.sjtu.edu.cn/dmne/faculty/teachers/',
              ]

a_s_xpath_str = '//div[@class="teacher_name_filed" and position()<11]//a'
target_div_xpath_str = '//div[id="wrapper"]/div[@class="container"]'
