...
school_name = '上海交通大学'
college_name = '电子信息与电气工程学院-计算机系'
school_id = 104
college_id = 161
img_url_head = None
partition_num = '021'
start_urls = [
                'https://www.cs.sjtu.edu.cn/Faculty.aspx',
              ]

a_s_xpath_str = '//div[@class="Main"]//div[@class="Faculty"]//a'

target_div_xpath_str = '//div[@class="PeopleDetail"]|//body'
