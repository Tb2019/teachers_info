...
partition_num = '021'
start_urls = [
                'https://smse.sjtu.edu.cn/people/staff/title'
              ]

a_s_xpath_str = '//div[@class="panel-item is-collapse open"]//div[@class="layui-row row-flex layui-col-space5"]//a'
target_div_xpath_str = '//div[@class="content-container"]'
