...
college_id = 140
start_urls = [
                'http://www.phys.ruc.edu.cn/szdw/jzry.htm',
                'http://www.phys.ruc.edu.cn/szdw/jzry/3.htm',
                'http://www.phys.ruc.edu.cn/szdw/jzry/2.htm',
                'http://www.phys.ruc.edu.cn/szdw/jzry/1.htm',
                'http://www.phys.ruc.edu.cn/szdw/sysry.htm'
              ]

a_s_xpath_str = '//ul[@class="m2tcul clearfix"]/li/a[@href!="#"]'
...
class SpecialSpider(ReCrawler):
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./div[@class="m2tcBom"]/strong/text()')
            # print(name)
            if name:
                name = ''.join(name)
