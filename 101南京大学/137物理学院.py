...
college_id = 137
start_urls = [
                'https://physics.nju.edu.cn/sz/zrjs/index.html',
                'https://physics.nju.edu.cn/sz/jcwljxzx/index.html',
                'https://physics.nju.edu.cn/sz/yzs/index.html'
              ]

a_s_xpath_str = '//div[@class="mn-infoList"]//a[@href!="#"]'
target_div_xpath_str = '//div[@class="mn-infoBox warp"]'
