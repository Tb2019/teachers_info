...
college_name = '沈元学院（高等理工学院、未来空天技术学院、国家卓越工程师学院）'
school_id = 109
college_id = 79
img_url_head = None
partition_num = '010'
start_urls = [
                'https://hc.buaa.edu.cn/rcpy/szdw1/skjs.htm',
                'https://hc.buaa.edu.cn/rcpy/szdw1/skjs/1.htm'
              ]

a_s_xpath_str = '//ul[@class="list_n_szdw2"]/li/a'
target_div_xpath_str = '//div[@style="padding: 0 15px"]|//form[@name="_newscontent_fromname"]|//div[@class="con_lr fr con_sz_nry"]|//div[@class="ContentBox"]|//div[@class="right_column float-left"]|//div[@class="home-page shadow-box"]|//form[@name="_newscontent_fromname"]|//div[@class="baseinfoBar clearfix"]|//div[@class="teach_main"]|//div[@class="dft-main clearfix"]'
