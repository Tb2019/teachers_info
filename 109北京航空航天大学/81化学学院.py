...
partition_num = '010'
start_urls = [
                'https://sce.buaa.edu.cn/szll/js.htm',
                'https://sce.buaa.edu.cn/szll/fjs.htm',
                'https://sce.buaa.edu.cn/szll/js1.htm',
              ]

a_s_xpath_str = '//ul[@class="clearfix"]/li/a'
target_div_xpath_str = '//div[@class="list-main-right"]'
