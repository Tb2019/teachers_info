...
college_name = '无人系统研究院'
school_id = 109
college_id = 83
img_url_head = None
partition_num = '010'
start_urls = [
                'https://wrj.buaa.edu.cn/szdw/bssds.htm',
                'https://wrj.buaa.edu.cn/szdw/sssds.htm',
              ]

a_s_xpath_str = '//div[@class="teacher-list"]/ul/li/a'
target_div_xpath_str = '//div[@class="ContentBox"]|//div[@class="dft-main clearfix"]|//div[@class="main_index page_width clearfix"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//p[@class="line1"]/text()')
            if name:
                name = ''.join(name)
