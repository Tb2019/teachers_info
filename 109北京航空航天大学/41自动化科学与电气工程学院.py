...
college_name = '自动化科学与电气工程学院'
school_id = 109
college_id = 41
img_url_head = None
partition_num = '010'
start_urls = [
                'https://dept3.buaa.edu.cn/szjs/zzjs/znxtykzgcx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/jcyzdhgcx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/jxdzgcx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/dqgcx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/zdkzx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/zdhjxsyzx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/dgdzjxsyzx.htm',
                'https://dept3.buaa.edu.cn/szjs/zzjs/gyhlwyjmfzx.htm',
              ]

a_s_xpath_str = '//div[@class="main"]//div//div//div//a'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_detail(self, detail_page, url):
        ...
        # phone = re.sub(r'——', '-', phone)
            ...
            email = None
            try:
                email_encrypt = re.search(r'id="_tsites_encryp_tsteacher_tsemail".*?>(.*?)<', page, re.S).group(1)
                import requests

                url = f"https://shi.buaa.edu.cn/system/resource/tsites/tsitesencrypt.jsp?id=_tsites_encryp_tsteacher_tsemail&content={email_encrypt}&mode=8"
                ...
                headers = {
                    ...
                    'Cookie': 'JSESSIONID=C738D6A7057C18C0E5C2EB9271B59FAA.tsiteshtm1; Hm_lvt_1a88819e81fa58adfcb7cb2475491760=1724124062,1724133518; HMACCOUNT=77F07663A5615BFC; Hm_lpvt_1a88819e81fa58adfcb7cb2475491760=1724133940',
                    'Referer': 'https://shi.buaa.edu.cn/gongguanghong/zh_CN/index.htm',
