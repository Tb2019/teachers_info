...
college_name = '空间与环境学院'
school_id = 109
college_id = 82
img_url_head = None
partition_num = '010'
start_urls = [
                'https://sse.buaa.edu.cn/szll/jsml.htm'
              ]

a_s_xpath_str = '//div[@class="szll2 auto"]/ul/li/a'
target_div_xpath_str = '//form[@name="_newscontent_fromname"]|//div[@class="ContentBox"]|//div[@class="baseinfoBar clearfix"]'
