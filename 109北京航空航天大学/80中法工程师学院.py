...
college_name = '中法工程师学院'
school_id = 109
college_id = 80
img_url_head = None
partition_num = '010'
start_urls = [
                'https://ecpkn.buaa.edu.cn/szdw/zyjx.htm',
                'https://ecpkn.buaa.edu.cn/szdw/syjx.htm'
              ]

a_s_xpath_str = '//ul[@class="picList clearfix"]/li//p[@class="fyjx-name"]/a'
