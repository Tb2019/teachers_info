...
partition_num = '010'
start_urls = [
                'https://sem.buaa.edu.cn/szll/szdw.htm',
                'https://sem.buaa.edu.cn/szll/szdw/zc/fjsfyjy.htm',
                'https://sem.buaa.edu.cn/szll/szdw/zc/js2.htm',
              ]

a_s_xpath_str = '//ul[@class="d-ldU3"]/li/a'
