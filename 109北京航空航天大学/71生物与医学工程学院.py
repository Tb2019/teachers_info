...
college_name = '生物与医学工程学院'
school_id = 109
college_id = 71
img_url_head = None
partition_num = '010'
start_urls = [
                'https://bme.buaa.edu.cn/teachers.aspx?catID=7'
              ]

a_s_xpath_str = '//div[@class="admissions"]//a[contains(@href, "cn")]'
target_div_xpath_str = '//*[@id="form1"]/table[3]/tbody/tr/td[2]/div[2]'
