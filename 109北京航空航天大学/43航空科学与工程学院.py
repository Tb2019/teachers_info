...
college_name = '航空科学与工程学院'
school_id = 109
college_id = 43
img_url_head = None
partition_num = '010'
start_urls = [f'http://www.ase.buaa.edu.cn/new/lyys.jsp?totalpage=16&PAGENUM={i}&urltype=tree.TreeTempUrl&wbtreeid=1079' for i in range(1, 17)] \
             + [f'http://www.ase.buaa.edu.cn/new/lyys.jsp?totalpage=15&PAGENUM={i}&urltype=tree.TreeTempUrl&wbtreeid=1080' for i in range(1, 16)]\
             + ['http://www.ase.buaa.edu.cn/new/lyys.jsp?totalpage=2&PAGENUM=1&urltype=tree.TreeTempUrl&wbtreeid=1081', 'http://www.ase.buaa.edu.cn/new/lyys.jsp?totalpage=2&PAGENUM=2&urltype=tree.TreeTempUrl&wbtreeid=1081', 'http://www.ase.buaa.edu.cn/new/lyys.jsp?urltype=tree.TreeTempUrl&wbtreeid=1172']

a_s_xpath_str = '//div[@class="zjList"]//li/a'
target_div_xpath_str = '//div[@class="box flex"]|//body'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//span[@class="name"]/text()')
            if name:
                name = ''.join(name)
