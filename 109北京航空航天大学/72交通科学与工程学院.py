...
college_name = '交通科学与工程学院'
school_id = 109
college_id = 72
img_url_head = None
partition_num = '010'
start_urls = [
                'https://transportation.buaa.edu.cn/szdw/szdw/jtysx.htm',
                'https://transportation.buaa.edu.cn/szdw/szdw/qcgcx.htm',
                'https://transportation.buaa.edu.cn/szdw/szdw/znjtjcssx.htm',
                'https://transportation.buaa.edu.cn/szdw/szdw/fxqshgcx.htm',
                'https://transportation.buaa.edu.cn/szdw/szdw/jtytmgcsyzx.htm'
              ]

a_s_xpath_str = '//div[@class="js_pic"]/ul/li//p/a'
target_div_xpath_str = '//div[@class="ContentBox"]|//div[@class="right_column float-left"]|//div[@class="home-page shadow-box"]|//form[@name="_newscontent_fromname"]|//div[@class="baseinfoBar clearfix"]|//div[@class="teach_main"]'
