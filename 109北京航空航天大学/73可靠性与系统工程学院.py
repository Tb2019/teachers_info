...
college_name = '可靠性与系统工程学院'
school_id = 109
college_id = 73
img_url_head = None
partition_num = '010'
start_urls = [
                'https://rse.buaa.edu.cn/system/resource/tsites/portal/queryteacher.jsp?collegeid=1100&isshowpage=false&postdutyid=0&postdutyname=&facultyid=&disciplineid=0&rankcode=RANK_TITLE_ID187393%252CRANK_TITLE_ID615838%252C&jobtypecode=&enrollid=0&pageindex=1&pagesize=50&login=true&profilelen=200&honorid=0&pinyin=&teacherName=&searchDirection=&viewmode=10&viewOwner=1564143197&viewid=1060790&siteOwner=1564143197&viewUniqueId=u11&showlang=zh_CN&actiontype=',
                'https://rse.buaa.edu.cn/system/resource/tsites/portal/queryteacher.jsp?collegeid=1100&isshowpage=false&postdutyid=0&postdutyname=&facultyid=&disciplineid=0&rankcode=1015%252C1014%252C812%252CRANK_TITLE_ID194169%252CRANK_TITLE_ID636811%252C982%252CRANK_TITLE_ID485904%252C&jobtypecode=&enrollid=0&pageindex=1&pagesize=60&login=false&profilelen=10&honorid=0&pinyin=&teacherName=&searchDirection=&viewmode=10&viewOwner=1564143197&viewid=1060527&siteOwner=1564143197&viewUniqueId=u11&showlang=zh_CN&actiontype=',
                'https://rse.buaa.edu.cn/system/resource/tsites/portal/queryteacher.jsp?collegeid=1100&isshowpage=false&postdutyid=0&postdutyname=&facultyid=&disciplineid=0&rankcode=1000%252C223D924F-7E46-4911-8EBD-F8D39A9D94B2%252CRANK_TITLE_ID202548%252CRANK_TITLE_ID678699%252CRANK_TITLE_ID511073%252CRANK_TITLE_ID339333%252C641%252C643%252C&jobtypecode=&enrollid=0&pageindex=1&pagesize=20&login=true&profilelen=10&honorid=0&pinyin=&teacherName=&searchDirection=&viewmode=10&viewOwner=1564143197&viewid=1060529&siteOwner=1564143197&viewUniqueId=u11&showlang=zh_CN&actiontype=',
              ]

a_s_xpath_str = ''
target_div_xpath_str = '//div[@class="ContentBox"]|//div[@class="right_column float-left"]|//div[@class="home-page shadow-box"]|//form[@name="_newscontent_fromname"]|//div[@class="baseinfoBar clearfix"]|//div[@class="teach_main"]|//div[@class="dft-main clearfix"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        headers = {
            ...
            'Cookie': 'JSESSIONID=F11EE3978EBB3B9436168C5CC718CC39',
            'Referer': 'https://rse.buaa.edu.cn/szdwzg.jsp?urltype=tree.TreeTempUrl&wbtreeid=1018',
        ...
        for info in response['teacherData']:
            name = info['name']
            link = info['url']
            yield name, link
