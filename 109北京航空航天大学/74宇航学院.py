...
partition_num = '010'
start_urls = [
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htfxqjsx.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htfxqjsx/3.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htfxqjsx/2.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htfxqjsx/1.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htzddhykzx.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htzddhykzx/1.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/yhtjx.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/yhtjx/3.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/yhtjx/2.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/yhtjx/1.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htxxgcx.htm',
                'http://www.sa.buaa.edu.cn/szdw/jsfc/htxxgcx/1.htm'
              ]

a_s_xpath_str = '//ul[@class="clearfix"]/li/a'
target_div_xpath_str = '//div[@class="con_lr fr con_sz_nry"]|//div[@class="ContentBox"]|//div[@class="right_column float-left"]|//div[@class="home-page shadow-box"]|//form[@name="_newscontent_fromname"]|//div[@class="baseinfoBar clearfix"]|//div[@class="teach_main"]|//div[@class="dft-main clearfix"]'
