...
img_url_head = None
partition_num = '010'
start_urls = ['https://scse.buaa.edu.cn/szdw/qtjs/js.htm', 'https://scse.buaa.edu.cn/szdw/qtjs/fjs.htm', 'https://scse.buaa.edu.cn/szdw/qtjs/js1.htm', 'https://scse.buaa.edu.cn/szdw/qtjs/js1/1.htm', 'https://scse.buaa.edu.cn/szdw/qtjs/sys.htm']\
            + [f'https://scse.buaa.edu.cn/szdw/qtjs/js/{i}.htm' for i in range(1, 6)]\
            + [f'https://scse.buaa.edu.cn/szdw/qtjs/fjs/{i}.htm' for i in range(1, 6)]

a_s_xpath_str = '/html/body/div[4]/div[1]/div[3]/div[2]/div/ul//a'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="img"]/p/text()')
            if name:
                name = ''.join(name)
