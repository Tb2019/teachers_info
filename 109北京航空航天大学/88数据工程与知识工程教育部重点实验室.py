...
college_name = '数据工程与知识工程教育部重点实验室'
school_id = 109
college_id = 88
img_url_head = None
partition_num = '010'
start_urls = [
                'http://deke.ruc.edu.cn/kytd/zzry/index.htm',
                'http://deke.ruc.edu.cn/kytd/qtgdry/index.htm'
              ]

a_s_xpath_str = '//div[@class="news_list clear"]/a'
target_div_xpath_str = '//div[@class="m_news_c"]'
