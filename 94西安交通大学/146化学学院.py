...
a_s_xpath_str = '//div[@id="vsb_content_4"]//a[@href!="#"]'
target_div_xpath_str = '//div[@class="portlet-layout row" or @class="hero-subscribe-right"]'
...
spider = SpecialSpider(
                   ...
                   img_url_head='https://gr.xjtu.edu.cn/',
