...
partition_num = '0755'
start_urls = [
                'https://saa.sysu.edu.cn/faculty',
                'https://saa.sysu.edu.cn/faculty/Researchers',
                'https://saa.sysu.edu.cn/faculty/laboratory-technician',
              ]

a_s_xpath_str = '//div[contains(@id, "teachers_departments-0")]//div[contains(@class, "js-view-dom-id")]/div//h4[@class="list-title one-line"]//a'
