...
partition_num = '0755'
start_urls = [
                # 'https://materials.sysu.edu.cn/faculty/staff',  # 无需重写第一个方法
                #
                'https://materials.sysu.edu.cn/faculty/engineering-technician'
              ]

# a_s_xpath_str = '//div[@class="block-region-right"]//ul[@class="nameList"]//a'
