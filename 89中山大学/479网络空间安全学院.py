...
partition_num = '0755'
start_urls = [
                'https://scst.sysu.edu.cn/members/members01/index.htm',
                'https://scst.sysu.edu.cn/members/members02/index.htm'
              ]

a_s_xpath_str = '//div[@class="cont"]//tr//a'
target_div_xpath_str = '//div[@class="cont"]|//body'
