...
school_name = '中山大学'
college_name = '测绘科学与技术学院'
school_id = 89
college_id = 514
img_url_head = None
partition_num = '0756'
start_urls = [
                'https://sges.sysu.edu.cn/cat/64',
                'https://sges.sysu.edu.cn/cat/65',
                'https://sges.sysu.edu.cn/cat/65?page=1',
                'https://sges.sysu.edu.cn/cat/65?page=2',
                'https://sges.sysu.edu.cn/cat/143',
                'https://sges.sysu.edu.cn/cat/67',
                'https://sges.sysu.edu.cn/cat/152'
              ]
