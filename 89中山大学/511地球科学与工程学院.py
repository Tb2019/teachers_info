...
school_name = '中山大学'
college_name = '地球科学与工程学院'
school_id = 89
college_id = 511
img_url_head = None
partition_num = '0756'
start_urls = [
                # 'https://gs.sysu.edu.cn/faculty',
                'https://gs.sysu.edu.cn/Full-time-researcher',
                'https://gs.sysu.edu.cn/post-doc',
                'https://gs.sysu.edu.cn/professors-parttime'
              ]

# a_s_xpath_str = '//div[@class="views-view-grid horizontal cols-2 clearfix"]//div[@class="list-images-1-1 inside-r "]//div[@class="list-content"]//h4/a'
a_s_xpath_str = '//div[@class="views-view-grid horizontal cols-2 clearfix"]//div[@class="list-images-1-1 inside-r "]//div[@class="list-content"]'
target_div_xpath_str = '//article//div[@class="inner"]'
