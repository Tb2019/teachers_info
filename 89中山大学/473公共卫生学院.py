...
partition_num = '0755'
start_urls = [
                'https://phs.sysu.edu.cn/zh-hans/faculty',
                'https://phs.sysu.edu.cn/zh-hans/faculty?page=1',
                'https://phs.sysu.edu.cn/zh-hans/faculty?page=2',
                'https://phs.sysu.edu.cn/zh-hans/faculty?page=3',
                'https://phs.sysu.edu.cn/zh-hans/faculty?page=4',
              ]

a_s_xpath_str = '//div[@class="col-sm-12"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="list-content"]/h4/strong/text()')
            if name:
                name = ''.join(name)
