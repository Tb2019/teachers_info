...
partition_num = '020'
start_urls = [
                'https://nursing.sysu.edu.cn/professors',
                'https://nursing.sysu.edu.cn/associate-professors',
                'https://nursing.sysu.edu.cn/associate-professors?page=1'
              ]

a_s_xpath_str = '//div[@class="list-images-1 inside-tb"]//div[@class="list-content"]'
target_div_xpath_str = '//div[@id="content"]//div[@class="row"][2]/div[@class="col-sm-12 col-md-9 region-right"]'
