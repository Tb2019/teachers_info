...
partition_num = '020'
start_urls = [
                'https://history.sysu.edu.cn/faculty/01',
                'https://history.sysu.edu.cn/faculty/02',
                'https://history.sysu.edu.cn/faculty/03',
                'https://history.sysu.edu.cn/faculty/04',
                'https://history.sysu.edu.cn/faculty/post-doctor',
              ]

a_s_xpath_str = '//div[@class="member col-lg-6"]//h4//a'
target_div_xpath_str = '//div[@class="inner"]/div[@class="row"][2]'
