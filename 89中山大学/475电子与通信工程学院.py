...
start_urls = [
                ...
                'https://sece.sysu.edu.cn/szll/js/rztx/index.htm',
                'https://sece.sysu.edu.cn/szll/js/kjdz/index.htm',
                'https://sece.sysu.edu.cn/szll/bshjzzkyry/index.htm'
              ]

a_s_xpath_str = '//ul[@class="listteacher"]//a'
...
spider = SpecialSpider(
                   ...
                   school_id=school_id,
                   college_id=college_id,
                   name_filter_re=r'(?:助理|副)?教授|讲师|博士后|特聘.*',
