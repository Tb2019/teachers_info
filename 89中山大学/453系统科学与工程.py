...
school_name = '中山大学'
college_name = '系统科学与工程'
school_id = 89
college_id = 453
img_url_head = None
partition_num = '020'
start_urls = [
                'https://ssse.sysu.edu.cn/teachers',
                'https://ssse.sysu.edu.cn/teachers/team',
              ]

a_s_xpath_str = '//div[@class="teacherslist"]/ul/li/a'
target_div_xpath_str = '//div[@class="block-region-content"]'
