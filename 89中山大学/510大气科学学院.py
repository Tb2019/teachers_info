...
partition_num = '0756'
start_urls = [
                'https://atmos.sysu.edu.cn/Professors',
                'https://atmos.sysu.edu.cn/Professors?page=1',
                'https://atmos.sysu.edu.cn/Professors?page=2',
                'https://atmos.sysu.edu.cn/Professors?page=3',
                'https://atmos.sysu.edu.cn/GuestProfessors',
                'https://atmos.sysu.edu.cn/AssociateProfessors',
                'https://atmos.sysu.edu.cn/AssociateProfessors?page=1',
                'https://atmos.sysu.edu.cn/AssociateProfessors?page=2',
                'https://atmos.sysu.edu.cn/AssociateProfessors?page=3',
                'https://atmos.sysu.edu.cn/AssociateProfessors?page=4',
                'https://atmos.sysu.edu.cn/AssociateProfessors?page=5',
                'https://atmos.sysu.edu.cn/AssociateProfessors?page=6',
                'https://atmos.sysu.edu.cn/AssistantProfessor',
                'https://atmos.sysu.edu.cn/SeniorEngineer',
                'https://atmos.sysu.edu.cn/Engineers',
                'https://atmos.sysu.edu.cn/Pd',
                'https://atmos.sysu.edu.cn/Pd?page=1',
                'https://atmos.sysu.edu.cn/Pd?page=2',
                'https://atmos.sysu.edu.cn/cat/68'
              ]

a_s_xpath_str = '//div[@class="col-sm-12"]//div[@class="list-content"]'
