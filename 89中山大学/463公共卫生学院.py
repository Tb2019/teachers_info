...
partition_num = '020'
start_urls = [
                'https://sph.sysu.edu.cn/professors',
                'https://sph.sysu.edu.cn/professors?page=1',
                'https://sph.sysu.edu.cn/professors?page=2',
                'https://sph.sysu.edu.cn/professors?page=3',
                'https://sph.sysu.edu.cn/associateprofessors',
                'https://sph.sysu.edu.cn/associateprofessors?page=1',
                'https://sph.sysu.edu.cn/associateprofessors?page=2',
                'https://sph.sysu.edu.cn/associateprofessors?page=3',
                'https://sph.sysu.edu.cn/associateprofessors?page=4',
                'https://sph.sysu.edu.cn/lecturer',
                'https://sph.sysu.edu.cn/cat/163'
              ]

a_s_xpath_str = '//div[@class="views-element-container"]//div[@class="col-sm-12"]//div[@class="list-content"]'
