...
school_name = '电子科技大学'
college_name = '光电科学与工程学院'
school_id = 90
college_id = 406
img_url_head = None
partition_num = '028'
start_urls = ['https://sose.uestc.edu.cn/szdw/jsml.htm'] + [f'https://sose.uestc.edu.cn/szdw/jsml/{i}.htm' for i in range(1, 25)]

a_s_xpath_str = '//div[@class="ej_szdw_z"]/ul/li/a'
target_div_xpath_str = '//div[@class="nry_main"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./div[@class="con"]/p/text()')
            if name:
                name = ''.join(name)
