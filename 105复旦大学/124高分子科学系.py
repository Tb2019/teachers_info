...
college_id = 124
start_urls = [
                'https://polymer.fudan.edu.cn/31402/list.htm'
              ]

a_s_xpath_str = '//div[@id="wp_news_w5"]//div[@class="lanmu_nr"]//a[contains(@href, "htm")]'
        ...
        # if not self.api:  # 不使用第三方api解析
            ...
            if self.phone_xpath:
                ...
                try:
                    ...
                    try:
                        phone_list.remove('021-31242888')
                    except:
                        try:
                            phone_list.remove('2009-20122012')  # 屈泽华
                        except:
                            pass
                    if len(phone_list) > 1:
