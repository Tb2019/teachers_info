...
college_id = 131
start_urls = [
                'https://aero-mech.fudan.edu.cn/js_25828/list.htm',
                'https://aero-mech.fudan.edu.cn/fjs_25829/list.htm',
                'https://aero-mech.fudan.edu.cn/js_25830/list.htm'
              ]

a_s_xpath_str = '//div[@id="wp_news_w6"]//tr//div[@class="albumn_info"]/span[2]/a'
        ...
        # if not self.api:  # 不使用第三方api解析
            ...
            if self.phone_xpath:
                ...
                try:
                    ...
                    if phone in ('475-4822006', '3162-31702011'):
                        phone = None
                except:
                    pass
            # phone = re.sub(r'——', '-', phone)
