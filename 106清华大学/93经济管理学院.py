...
img_url_head = None
partition_num = '010'
start_urls = ['https://www.sem.tsinghua.edu.cn/js/szdw/zzjs.htm'] + [f'https://www.sem.tsinghua.edu.cn/js/szdw/zzjs/{i}.htm' for i in range(1, 15)]

a_s_xpath_str = '//div[@class="detailsitem"]/div'
