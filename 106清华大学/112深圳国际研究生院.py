...
school_name = '清华大学'
college_name = '深圳国际研究生院'
school_id = 106
college_id = 112
img_url_head = None
partition_num = '010'
start_urls = [
                'https://www.sigs.tsinghua.edu.cn/szdwlby/list.htm'
              ]

a_s_xpath_str = '//div[@class="conz"]//li/a'
target_div_xpath_str = '//div[@class="project-search teacher_home" or @class="wrapper"]'
