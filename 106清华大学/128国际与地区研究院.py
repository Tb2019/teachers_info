...
school_name = '清华大学'
college_name = '国际与地区研究院'
school_id = 106
college_id = 128
img_url_head = None
partition_num = '010'
start_urls = [
                'https://iias.tsinghua.edu.cn/szry/js.htm',
                'https://iias.tsinghua.edu.cn/szry/jkjs.htm',
                'https://iias.tsinghua.edu.cn/szry/jxjstz.htm',
                'https://iias.tsinghua.edu.cn/szry/zyfwjs.htm',
                'https://iias.tsinghua.edu.cn/szry/xztd.htm'
              ]

a_s_xpath_str = '//div[@class="item-box"]/a'
