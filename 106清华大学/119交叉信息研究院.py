...
school_name = '清华大学'
college_name = '交叉信息研究院'
school_id = 106
college_id = 119
img_url_head = None
partition_num = '010'
start_urls = [
                'https://iiis.tsinghua.edu.cn/people/#jy2'
              ]

a_s_xpath_str = '//body/div[contains(@class, "boxPtb")]//div[@class="list_team"]//li//div[@class="name"]/a'
target_div_xpath_str = '//div[@class="user-content"]/div[@class="container"]'
