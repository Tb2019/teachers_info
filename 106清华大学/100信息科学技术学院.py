...
start_urls = [
                ...
                # 'https://www.ee.tsinghua.edu.cn/ryqk/kzjs/spjs.htm',

                # 'https://www.cs.tsinghua.edu.cn/szzk/jzgml.htm',

                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/kzyjcyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/xxclyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/xtgcyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/jcydzjsyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/dhykzyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/gyznyxtyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/nyrzkxyjs.htm',
                # 'https://www.au.tsinghua.edu.cn/szdw/jsdw1/ayjscz/zdhsyjxzx.htm',

                # 'https://www.ime.tsinghua.edu.cn/szdw/jyry.htm',
                # 'https://www.ime.tsinghua.edu.cn/szdw/jyry/2.htm',
                # 'https://www.ime.tsinghua.edu.cn/szdw/jyry/1.htm',
                # 'https://www.ime.tsinghua.edu.cn/szdw/kzjs/jxjstz.htm',

                # 'https://www.thss.tsinghua.edu.cn/szdw/jsml.htm',

                'https://www.insc.tsinghua.edu.cn/szdw_/zzjs.htm'
              ]

# a_s_xpath_str = '//ul[@class="ul-listb3"]/li//div[@class="line"]//a'

# a_s_xpath_str = '//div[@class="people01-nr"]/dl/dd/ul/li/div[@class="text"]/h2/a'

# a_s_xpath_str = '//ul[@class="list13 flex"]/li/a'

# a_s_xpath_str = '//div[@class="sz-cont"]/ul[@class="flex"]/li/a'  # 重写姓名获取方式

# a_s_xpath_str = '//div[@class="group-people"]/div[@class="name-container"]/a'

a_s_xpath_str = '//div[@id="vsb_content"]//a'

# target_div_xpath_str = '//div[@class="main"]|//div[@class="baseinfoBar clearfix"]|//td[@id="layout-content"]|//div[@class="tex2jax"]'
# target_div_xpath_str = '//div[@id="vsb_content_2"]'
# target_div_xpath_str = '//form[@name="_newscontent_fromname"]'
# target_div_xpath_str = '//form[@name="_newscontent_fromname"]|//div[@class="mw-parser-output"]'
# target_div_xpath_str = '//div[@class="page"]'
target_div_xpath_str = '//form[@name="_newscontent_fromname"]'
