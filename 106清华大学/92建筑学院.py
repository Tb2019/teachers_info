...
partition_num = '010'
start_urls = [
                'https://www.arch.tsinghua.edu.cn/column/rw'
              ]

a_s_xpath_str = '//div[@class="tabContent"]/ul/li/div[@class="name"]/a'
target_div_xpath_str = '//div[@class="characterShow_01" or @class="wal characterShow"]'
