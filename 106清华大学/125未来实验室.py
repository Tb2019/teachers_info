...
partition_num = '010'
start_urls = [
                'https://thfl.tsinghua.edu.cn/yjdw/jzg/zxjg.htm',
                'https://thfl.tsinghua.edu.cn/yjdw/bsh/zxjg.htm',
                'https://thfl.tsinghua.edu.cn/yjdw/yjs/zxjg.htm',
              ]

a_s_xpath_str = '//ul[@class="teacher"]/li/a'
target_div_xpath_str = '//div[@class="sub_01_article"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="title fs28"]/text()')
            if name:
                name = ''.join(name)
