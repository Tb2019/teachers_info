...
school_name = '清华大学'
college_name = '生物医学交叉研究院'
school_id = 106
college_id = 123
img_url_head = None
partition_num = '010'
start_urls = [
                'https://www.timbr.tsinghua.edu.cn/kxyj/kytuan_d.htm',
                'https://www.timbr.tsinghua.edu.cn/kxyj/kytuan_d/2.htm',
                'https://www.timbr.tsinghua.edu.cn/kxyj/kytuan_d/1.htm',
              ]

a_s_xpath_str = '/html/body/div[2]/div[2]/div[3]/ul/li/a'
