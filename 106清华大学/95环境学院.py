...
partition_num = '010'
start_urls = [
                # 'https://www.env.tsinghua.edu.cn/szdw/ys.htm',

                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/shjbh.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/gspsjys.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/trydxsjys.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/dq.htm',
                'https://www.env.tsinghua.edu.cn/szdw/jyjs/gts.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/hjhx.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/hjswx.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/hjstxjys.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/DEH.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/htxt.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/hjglyzc.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/DES.htm',
                # 'https://www.env.tsinghua.edu.cn/szdw/jyjs/szysst.htm'
              ]

# a_s_xpath_str = '//div[@class="leader-person leader-person-academician"]'
a_s_xpath_str = '//div[@class="academician-inner-content"]/a[3]'
target_div_xpath_str = '//div[@class="teacher-details"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./@title')
            # name = a.xpath('.//p[@class="leader-person-name"]/text()')
            if name:
                name = ''.join(name)
                ...
                try:
                    link = a.xpath('./@href')[0]
                    # link = a.xpath('./@onclick')[0]
                    # link = re.search(r'window.*?\'(.*?)\'', link, re.S).group(1)
                    if link in ('#',):
                        continue
