...
partition_num = '010'
start_urls = [
                'https://astro.tsinghua.edu.cn/zh/ry/js.htm'
              ]

a_s_xpath_str = '//table[@class="category table table-bordered table-striped"]//tr//a'
target_div_xpath_str = '//div[@class="content_right"]'
