...
partition_num = '010'
start_urls = [
                'https://www.phys.tsinghua.edu.cn/ry/jsfc/apysx.htm',
                'https://www.phys.tsinghua.edu.cn/ry/jsry.htm',
                'https://www.phys.tsinghua.edu.cn/ry/xzry.htm',
              ]

a_s_xpath_str = '//div[@class="pull-right right-width"]//ul/li//a'
