...
school_name = '清华大学'
college_name = '脑与智能实验室'
school_id = 106
college_id = 126
img_url_head = None
partition_num = '010'
start_urls = [
                # 'https://brain.tsinghua.edu.cn/td/sysld.htm',

                'https://brain.tsinghua.edu.cn/td/yjry.htm',
              ]

# a_s_xpath_str = '//div[@class="list01"]//li/a'
a_s_xpath_str = '//div[@class="list02"]//li/a'
