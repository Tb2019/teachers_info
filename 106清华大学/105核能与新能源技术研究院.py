...
school_name = '清华大学'
college_name = '核能与新能源技术研究院'
school_id = 106
college_id = 105
img_url_head = None
partition_num = '010'
start_urls = [
                'https://www.inet.tsinghua.edu.cn/szdw/zgzc.htm',
                'https://www.inet.tsinghua.edu.cn/szdw/fgzc.htm',
              ]

a_s_xpath_str = '//div[@class="article-box1"]/div[@style="text-align: left;height:50px;"]//li//a'
