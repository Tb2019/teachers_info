...
school_name = '清华大学'
college_name = '出土文献研究与保护中心'
school_id = 106
college_id = 91
img_url_head = None
partition_num = '010'
start_urls = [
                'https://www.ctwx.tsinghua.edu.cn/szdw/qzjs.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/qzjs/2.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/qzjs/1.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/ry_jz.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/bsh.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/bsh/3.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/bsh/2.htm',
                # 'https://www.ctwx.tsinghua.edu.cn/szdw/bsh/1.htm',
              ]
