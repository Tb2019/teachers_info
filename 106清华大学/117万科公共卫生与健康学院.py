...
school_name = '清华大学'
college_name = '万科公共卫生与健康学院'
school_id = 106
college_id = 117
img_url_head = None
partition_num = '010'
start_urls = [
                'https://vsph.tsinghua.edu.cn/szdw/zzjs.htm',
                'https://vsph.tsinghua.edu.cn/szdw/tpjs.htm'
              ]

a_s_xpath_str = '//div[@class="team"]//li//div[@class="txt"]/a'
target_div_xpath_str = '//div[@class="team_xq"]'
