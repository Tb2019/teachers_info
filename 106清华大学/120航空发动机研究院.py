...
school_name = '清华大学'
college_name = '航空发动机研究院'
school_id = 106
college_id = 120
img_url_head = None
partition_num = '010'
start_urls = [
                'https://www.ae.tsinghua.edu.cn/ryqk/lyys_.htm',
                'https://www.ae.tsinghua.edu.cn/ryqk/zgzc.htm',
                'https://www.ae.tsinghua.edu.cn/ryqk/fgzc.htm',
                'https://www.ae.tsinghua.edu.cn/ryqk/zjzc.htm'
              ]

a_s_xpath_str = '//div[@class="teach-item"]//li/a'
