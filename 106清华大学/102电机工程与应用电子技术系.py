...
school_name = '清华大学'
college_name = '电机工程与应用电子技术系'
school_id = 106
college_id = 102
img_url_head = None
partition_num = '010'
start_urls = ['https://www.eea.tsinghua.edu.cn/szdw/zzjs/qbjs/all.htm'] + [f'https://www.eea.tsinghua.edu.cn/szdw/zzjs/qbjs/all/{i}.htm' for i in range(1, 17)]

a_s_xpath_str = '//ul[@class="clearfix"]/li/a'
target_div_xpath_str = '//section[@class="newscontent"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="con fr"]/p[1]/text()')
            if name:
                name = ''.join(name)
