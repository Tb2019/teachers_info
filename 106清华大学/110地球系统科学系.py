...
school_name = '清华大学'
college_name = '地球系统科学系'
school_id = 106
college_id = 110
img_url_head = None
partition_num = '010'
start_urls = [
                # 'https://www.dess.tsinghua.edu.cn/sz/qzjss/anxke/stx.htm',

                'https://www.dess.tsinghua.edu.cn/sz/kxzdwyh.htm',
                'https://www.dess.tsinghua.edu.cn/sz/kxzdwyh/2.htm',
                'https://www.dess.tsinghua.edu.cn/sz/kxzdwyh/1.htm',
                'https://www.dess.tsinghua.edu.cn/sz/jxjs.htm',
                'https://www.dess.tsinghua.edu.cn/sz/spjs1.htm',
                'https://www.dess.tsinghua.edu.cn/sz/bsh.htm'
              ]

# a_s_xpath_str = '//ul[@id="teachertypedata"]//table//tr//a'

a_s_xpath_str = '//section[@class="n_renwu"]//li/a'  # 姓名需要重写方法

# target_div_xpath_str = '//div[@class="infor" or @class="dft-main clearfix"]'
