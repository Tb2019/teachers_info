...
school_name = '哈尔滨工业大学'
college_name = '特种环境复合材料技术国家级重点实验室'
school_id = 110
college_id = 31
img_url_head = None
partition_num = '0451'
start_urls = [
                'https://ccms.hit.edu.cn/13790/list.htm',
                'https://ccms.hit.edu.cn/13791/list.htm',
                'https://ccms.hit.edu.cn/13792/list.htm',
              ]

a_s_xpath_str = '//*[@id="wp_content_w6_0"]/table/tbody//a'
