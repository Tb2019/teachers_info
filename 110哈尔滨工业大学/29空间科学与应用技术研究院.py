...
school_name = '哈尔滨工业大学'
college_name = '空间科学与应用技术研究院'
school_id = 110
college_id = 29
img_url_head = None
partition_num = '0755'
start_urls = [
                'http://issat.hitsz.edu.cn/team.jsp?urltype=tree.TreeTempUrl&wbtreeid=1085',
                'http://issat.hitsz.edu.cn/team.jsp?totalpage=2&PAGENUM=2&urltype=tree.TreeTempUrl&wbtreeid=1085',
                'http://issat.hitsz.edu.cn/team.jsp?urltype=tree.TreeTempUrl&wbtreeid=1086',
                'http://issat.hitsz.edu.cn/team.jsp?urltype=tree.TreeTempUrl&wbtreeid=1087'
              ]

a_s_xpath_str = '//*[@id="tab"]/div[2]/div/div[2]/div/div[1]/div/a'
target_div_xpath_str = '//form[@name="_newscontent_fromname"]|//body'
...
spider = SpecialSpider(
                   ...
                   school_id=school_id,
                   college_id=college_id,
                   name_filter_re=r'(?:副|助理)?(?:教授.*|研究员.*|院士.*|博士后.*|研究院.*|临近空间.*)',
