...
school_name = '哈尔滨工业大学'
college_name = '生物能源开发利用国家地方联合工程研究中心'
school_id = 110
college_id = 34
img_url_head = None
partition_num = '0451'
start_urls = [
                'https://nercb.hit.edu.cn/19018/list.htm',
                'https://nercb.hit.edu.cn/19019/list.htm'
              ]

a_s_xpath_str = '//*[@id="wp_content_w6_0"]/table/tbody/tr/td//a'
