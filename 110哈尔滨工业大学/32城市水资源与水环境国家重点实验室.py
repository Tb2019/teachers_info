...
school_name = '哈尔滨工业大学'
college_name = '城市水资源与水环境国家重点实验室'
school_id = 110
college_id = 32
img_url_head = None
partition_num = '0451'
start_urls = [
                # 'https://waterlab.hit.edu.cn/lyys/list.htm',
                'https://waterlab.hit.edu.cn/yjry/list.htm',
              ]

# a_s_xpath_str = '//*[@id="wp_content_w6_0"]/table/tbody/tr//a'
a_s_xpath_str = '//*[@id="wp_content_w6_0"]/div/div/div/table/tbody/tr/td/a'
