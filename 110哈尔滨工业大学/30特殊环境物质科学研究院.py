...
school_name = '哈尔滨工业大学'
college_name = '特殊环境物质科学研究院'
school_id = 110
college_id = 30
img_url_head = None
partition_num = '0755'
start_urls = [
                'http://iseps.hitsz.edu.cn/rcdw/rygc/jsxl.htm',
                'http://iseps.hitsz.edu.cn/rcdw/rygc/jsxl/1.htm',
                'http://iseps.hitsz.edu.cn/rcdw/rygc/xzfw.htm',
              ]

a_s_xpath_str = '//*[@id="tab"]/div[2]/div/div[2]/div/div/div/div/div/a'
...
spider = SpecialSpider(
                   ...
                   school_id=school_id,
                   college_id=college_id,
                   name_filter_re=r'(?:副|助理|高级)?(?:教授.*|研究员.*|工程师.*|实验师.*|常务副院长.*|基本信息.*)',
