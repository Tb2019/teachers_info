...
partition_num = '0631'
start_urls = [
                # 'https://snaoe.hitwh.edu.cn/44/list.htm',
                # 'https://snaoe.hitwh.edu.cn/45/list.htm',
                # 'https://snaoe.hitwh.edu.cn/tmgcx/list.htm',
                'https://snaoe.hitwh.edu.cn/46/list.htm',
                'https://snaoe.hitwh.edu.cn/lxjxb/list.htm',
                # 'https://snaoe.hitwh.edu.cn/tyscyzhsc/list.htm',
              ]

a_s_xpath_str = '//*[@id="wp_content_w42_0"]//table//a'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            # name = a.xpath('./@sudyfile-attr')
            name = a.xpath('.//text()')
            if name:
                name = ''.join(name)
                # name = demjson3.decode(name)['title']
                # if '(' or '（' not in name:
                #     name = a.xpath('.//text()')
                #     name = ''.join(name)
