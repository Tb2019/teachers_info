...
school_name = '哈尔滨工业大学'
college_name = '医学与健康学院'
school_id = 110
college_id = 12
img_url_head = None
partition_num = '0451'
start_urls = [
                'https://med.hit.edu.cn/bssds/list.htm',
                'https://med.hit.edu.cn/sssds/list.htm',
                'https://med.hit.edu.cn/zljsyjs/list.htm',
              ]

a_s_xpath_str = '//*[@id="wp_content_w6_0"]/table//td//a'
