...
partition_num = '0755'
start_urls = [
                'http://mse.hitsz.edu.cn/szll/szdw.htm',
                'http://mse.hitsz.edu.cn/szll/szdw/5.htm',
                'http://mse.hitsz.edu.cn/szll/szdw/4.htm',
                'http://mse.hitsz.edu.cn/szll/szdw/3.htm',
                'http://mse.hitsz.edu.cn/szll/szdw/2.htm',
                'http://mse.hitsz.edu.cn/szll/szdw/1.htm',
              ]

a_s_xpath_str = '//*[@id="InsideRight"]/div[3]/div[1]/a'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="name fz24 cut trans"]/text()')
            if name:
                name = ''.join(name)
