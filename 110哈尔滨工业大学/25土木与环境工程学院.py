...
school_name = '哈尔滨工业大学'
college_name = '土木与环境工程学院'
school_id = 110
college_id = 25
img_url_head = None
partition_num = '0755'
start_urls = [
                # 'http://sce.hitsz.edu.cn/szll/jsdw/qzjs/js1.htm',
                # 'http://sce.hitsz.edu.cn/szll/jsdw/qzjs/js1/1.htm',
                # 'http://sce.hitsz.edu.cn/szll/jsdw/qzjs/fjs1.htm',
                'http://sce.hitsz.edu.cn/szll/jsdw/qzjs/zljs1.htm',
                'http://sce.hitsz.edu.cn/szll/jsdw/qzjs/yjy1.htm',
              ]

a_s_xpath_str = '/html/body/div[5]/div[2]/dl/dd/h2/a'
