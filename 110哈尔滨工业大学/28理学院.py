...
partition_num = '0755'
start_urls = [
                # 'http://ssc.hitsz.edu.cn/szdw/qzjs/yz.htm',
                # 'http://ssc.hitsz.edu.cn/szdw/qzjs/fyz.htm',

                # 'http://ssc.hitsz.edu.cn/szdw/qzjs/js.htm',
                # 'http://ssc.hitsz.edu.cn/szdw/qzjs/fjs.htm',
                # 'http://ssc.hitsz.edu.cn/szdw/qzjs/zljs.htm',
                # 'http://ssc.hitsz.edu.cn/szdw/qzjs/zjtp.htm',

                'http://ssc.hitsz.edu.cn/szdw/qzjs/kyg.htm',
              ]

# a_s_xpath_str = '/html/body/div[3]/div/div/ul/li/a'
# a_s_xpath_str = '//div[@class="con_rightPhotoList"]/ul/li/a'
a_s_xpath_str = '//div[@class="con_rightPhoto"]/ul/li/a'
