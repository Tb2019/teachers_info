...
school_name = '哈尔滨工业大学'
college_name = '仪器科学与工程学院'
school_id = 110
college_id = 6
img_url_head = None
partition_num = '0451'
start_urls = [
                'https://ise.hit.edu.cn/16179/list.htm',
                'https://ise.hit.edu.cn/16180/list.htm',
                'https://ise.hit.edu.cn/16181/list.htm',
              ]

a_s_xpath_str = '//*[@id="l-container"]/div/div/div[2]/div/div[2]/div/div/ul/li/ul/li//a'
