...
partition_num = '0451'
start_urls = [
                # 'http://mse.hit.edu.cn/16920/list.htm',
                #
                'https://mse.hit.edu.cn/16921/list.htm'
              ]

# a_s_xpath_str = '//ul[@class="ul-perlist fix"]/li//div[@class="name"]/a[1]'
a_s_xpath_str = '//*[@id="wp_content_w6_0"]/div/div/table/tbody/tr//a'
