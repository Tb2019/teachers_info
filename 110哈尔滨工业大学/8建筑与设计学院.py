...
img_url_head = None
partition_num = '0451'
start_urls = [f'http://arch.hit.edu.cn/11963/list{i}.htm' for i in range(1, 11)] + [f'http://arch.hit.edu.cn/11963/list{i}.psp' for i in range(11, 16)]

a_s_xpath_str = '//div[@id="wp_news_w6"]//tr/td//span[@class="Article_Title"]/a'
