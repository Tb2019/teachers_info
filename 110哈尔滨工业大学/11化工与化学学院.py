...
school_name = '哈尔滨工业大学'
college_name = '化工与化学学院'
school_id = 110
college_id = 11
img_url_head = None
partition_num = '0451'
start_urls = [
                'http://chemeng.hit.edu.cn/gcx/list.htm',
                'http://chemeng.hit.edu.cn/2496/list.htm',
                'http://chemeng.hit.edu.cn/6420/list.htm',
                'http://chemeng.hit.edu.cn/2498/list.htm',
                'http://chemeng.hit.edu.cn/6421/list.htm',
                'http://chemeng.hit.edu.cn/6422/list.htm',
                'http://chemeng.hit.edu.cn/2501/list.htm',
                'http://chemeng.hit.edu.cn/hxynyclyjs/list.htm',
                'http://chemeng.hit.edu.cn/6423/list.htm',
              ]

a_s_xpath_str = '//*[@id="l-container"]/div/div/div[2]/div/div/div/div[1]/ul/li/a'
    ...
    def parse_detail(self, detail_page, url):
        if detail_page:
            ...
            try:
                ...
                try:
                    a = target_div.xpath('.//tr[last()]/td[2]//text()')[0]
                    try:
                        driver.get(a)
                        time.sleep(1)
                        target_div = etree.HTML(driver.page_source).xpath('//body')[0]
                    except:
                        pass
                except:
                    print('没有链接')
