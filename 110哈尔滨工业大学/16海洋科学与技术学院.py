...
school_name = '哈尔滨工业大学'
college_name = '海洋科学与技术学院'
school_id = 110
college_id = 16
img_url_head = None
partition_num = '0631'
start_urls = [
                'http://marine.hitwh.edu.cn/hjgcx/list.htm',
                'http://marine.hitwh.edu.cn/swgcx/list.htm',
                'http://marine.hitwh.edu.cn/yyhxx/list.htm',
                'http://marine.hitwh.edu.cn/1486/list.htm'
              ]

a_s_xpath_str = '//*[@id="wp_news_w1106"]/ul/li/p[2]/a'
