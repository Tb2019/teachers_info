...
partition_num = '0451'
start_urls = [
                # 'http://life.hit.edu.cn/jzyg/list.htm',
                'http://life.hit.edu.cn/jzjs/list.htm',
              ]

a_s_xpath_str = '//*[@id="wp_content_w6_0"]/table/tbody//td//a'
# a_s_xpath_str = ' //*[@id="wp_content_w6_0"]/table[1]//td//a'
