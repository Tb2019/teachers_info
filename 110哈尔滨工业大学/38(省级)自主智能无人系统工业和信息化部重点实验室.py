...
school_name = '哈尔滨工业大学'
college_name = '(省级)自主智能无人系统工业和信息化部重点实验室'
school_id = 110
college_id = 38
img_url_head = None
partition_num = '0451'
start_urls = [
                'https://aius.hit.edu.cn/12903/list.htm',
                'https://aius.hit.edu.cn/bsh2/list.htm'
              ]

a_s_xpath_str = '//*[@id="l-container"]/div/div/div[2]/div/div[2]/div/div/ul/li//tbody//td[3]'
