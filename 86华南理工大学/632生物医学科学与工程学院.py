...
school_name = '华南理工大学'
college_name = '生物医学科学与工程学院'
school_id = 86
college_id = 632
img_url_head = None
partition_num = '020'
start_urls = [
                'https://www2.scut.edu.cn/bmse/jzry/list.htm',
                'https://www2.scut.edu.cn/bmse/jzry/list2.htm',
                'https://www2.scut.edu.cn/bmse/jzry/list3.htm',
                'https://www2.scut.edu.cn/bmse/zzyjxlry/list.htm',
                'https://www2.scut.edu.cn/bmse/bsh_26993/list.htm',
              ]

a_s_xpath_str = '//div[@class="teachers-list"]//li/a'
target_div_xpath_str = '//div[@class="inside-right"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="name"]/text()')
            if name:
                name = ''.join(name)
