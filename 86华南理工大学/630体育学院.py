...
partition_num = '020'
start_urls = [
                'https://www2.scut.edu.cn/spe/20920/list.htm',
                'https://www2.scut.edu.cn/spe/20921/list.htm',
                'https://www2.scut.edu.cn/spe/20922/list.htm',
              ]

a_s_xpath_str = '//ul[@class="teacher_list"]/li//div[@class="title"]/a'
target_div_xpath_str = '//div[@class="info-content"]'
