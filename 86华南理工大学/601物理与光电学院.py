...
school_name = '华南理工大学'
college_name = '物理与光电学院'
school_id = 86
college_id = 601
img_url_head = None
partition_num = '020'
start_urls = [
                # 'https://www2.scut.edu.cn/physics/13953/list.htm',
                # 'https://www2.scut.edu.cn/physics/13953/list2.htm',
                # 'https://www2.scut.edu.cn/physics/13953/list3.htm',
                # 'https://www2.scut.edu.cn/physics/13953/list4.htm',
                # 'https://www2.scut.edu.cn/physics/13954/list.htm',
                # 'https://www2.scut.edu.cn/physics/13954/list2.htm',
                # 'https://www2.scut.edu.cn/physics/13954/list3.htm',

                'https://www2.scut.edu.cn/physics/13952/list.htm',
              ]

# a_s_xpath_str = '//ul[@class="wp_article_list"]/li/span[@class="Article_Title"]/a'
a_s_xpath_str = '//ul[@class="news_list list2 clearfix"]/li//div[@class="news_title"]/a'
# target_div_xpath_str = '//div[@class="article"]'
target_div_xpath_str = '//div[@class="title_bar"]'
