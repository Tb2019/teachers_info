...
school_name = '华南理工大学'
college_name = '轻工科学与工程学院'
school_id = 86
college_id = 599
img_url_head = None
partition_num = '020'
start_urls = [
                'https://www2.scut.edu.cn/qgkxygc/js/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/yjy/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/jsjgg/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/fjs/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/fyjy/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/gjgcs/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/gcs/list.htm',
                'https://www2.scut.edu.cn/qgkxygc/js_13063/list.htm'
              ]

a_s_xpath_str = '//ul[@class="teacherlist"]/li/span/a'
target_div_xpath_str = '//div[@id="parId"]'
