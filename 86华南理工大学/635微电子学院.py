...
partition_num = '020'
start_urls = [
                'https://www2.scut.edu.cn/microelectronics/bd/list.htm',
                'https://www2.scut.edu.cn/microelectronics/sd/list.htm',
                'https://www2.scut.edu.cn/microelectronics/syry/list.htm',
              ]

a_s_xpath_str = '//ul[@class="list-list teacher-list clearfix"]/li/a'
