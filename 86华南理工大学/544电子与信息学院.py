...
partition_num = '020'
start_urls = [
                # 'https://www2.scut.edu.cn/ee/dzkxyjs/list.htm',
                'https://www2.scut.edu.cn/ee/xxytxgc/list.htm',
                # 'https://www2.scut.edu.cn/ee/xxytxgc/list2.htm',
                # 'https://www2.scut.edu.cn/ee/xxytxgc/list3.htm',
                # 'https://www2.scut.edu.cn/ee/dzxx/list.htm',
                # 'https://www2.scut.edu.cn/ee/dzxx/list2.htm',
                ...
                # 'https://www2.scut.edu.cn/ee/xxytxgc_36364/list4.htm',
                ...
                # 'https://www2.scut.edu.cn/ee/dzxx_36365/list5.htm'
              ]

a_s_xpath_str = '//ul[@class="te-item"]/li[12]//div[@class="te-title"]/a'
