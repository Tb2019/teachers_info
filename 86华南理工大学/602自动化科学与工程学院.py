...
school_name = '华南理工大学'
college_name = '自动化科学与工程学院'
school_id = 86
college_id = 602
img_url_head = None
partition_num = '020'
start_urls = [
                'https://www2.scut.edu.cn/automation/bssds/list.htm',
                'https://www2.scut.edu.cn/automation/bssds/list2.htm',
                'https://www2.scut.edu.cn/automation/sssds/list.htm',
                'https://www2.scut.edu.cn/automation/qt/list.htm',
                'https://www2.scut.edu.cn/automation/syzxjs/list.htm'
              ]

a_s_xpath_str = '//ul[@class="tea-list"]/li'
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            ...
            if name:
                ...
                try:
                    link = a.xpath('.//h4/a/@href')[0]
                    if link in ('#',):
                        continue
                    link = parse.urljoin(url, link)
                except:
                    continue
                img = a.xpath('./div[@class="tea-img"]/a/img/@src')[0]
