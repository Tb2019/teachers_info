...
college_id = 138
start_urls = [
                'https://ele.pku.edu.cn/szdw/ys.htm',
                'https://ele.pku.edu.cn/szdw/zzjs.htm',
                'https://ele.pku.edu.cn/szdw/zzjs/5.htm',
                'https://ele.pku.edu.cn/szdw/zzjs/4.htm',
                'https://ele.pku.edu.cn/szdw/zzjs/3.htm',
                'https://ele.pku.edu.cn/szdw/zzjs/2.htm',
                'https://ele.pku.edu.cn/szdw/zzjs/1.htm'
              ]

a_s_xpath_str = '//ul[@id="teachernamelist"]/li/div[@class="txt"]//a[@href!="#"]'
