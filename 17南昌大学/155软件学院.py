...
partition_num = '0791'
start_urls = [
                'https://soft.ncu.edu.cn/szdw/zzjs/index.htm',
              ]

a_s_xpath_str = '//div[@class="views-row views-row-1" or @class="views-row views-row-0"]//div[@class="name"]//a[@href!="#"]'
target_div_xpath_str = '//div[@class="newsright fl wow"]'
