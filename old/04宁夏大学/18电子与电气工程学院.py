...
school_name = '宁夏大学'
college_name = '电子与电气工程学院'
school_id = 4
college_id = 18
start_urls = ['https://seee.nxu.edu.cn/szdw/zrjs/qb.htm',
              'https://seee.nxu.edu.cn/szdw/yjsds.htm',
              'https://seee.nxu.edu.cn/szdw/yjsds/1.htm']

a_s_xpath_str = '//div[@class="fl02" or @class="xyfg"]/ul//a'
target_div_xpath_str = '//div[@class="szxq"]'
# # 研究方向
...
class SpecialSpider(ReCrawler):
    def parse_detail(self, detail_page, url):
        if detail_page:
            ...
            phone = None
            try:
                phone = page_tree.xpath('//div[@class="con wl"]/p[1]/text()')[0]
                phone = re.sub('"|“', '', phone)
            except:
                pass
            ...
            email = None
            try:
                email = page_tree.xpath('//div[@class="con wl"]/p[2]/text()')[0]
