...
school_name = '宁夏大学'
college_name = '食品科学与工程学院'
school_id = 4
college_id = 22
start_urls = ['https://spxy.nxu.edu.cn/szdw/xyjs.htm',
              'https://spxy.nxu.edu.cn/szdw/xyjs/3.htm',
              'https://spxy.nxu.edu.cn/szdw/xyjs/2.htm',
              'https://spxy.nxu.edu.cn/szdw/xyjs/1.htm']

a_s_xpath_str = '//div[@class="xrld"]//ul//a[@href!="#"]'
...
class SpecialSpider(ReCrawler):
    def parse_detail(self, detail_page, url):
        if detail_page:
            ...
            email = None
            try:
                email = page_tree.xpath('//div[@class="js-tx"]/p[3]/text()')[0]
                email = re.sub(r'邮箱(?::|：)', '', email)
