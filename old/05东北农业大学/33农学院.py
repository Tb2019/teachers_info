...
school_id = 5
college_id = 33
start_urls = ['https://nxy.neau.edu.cn/szdw.htm']

a_s_xpath_str = '//div[@class="szdw clearfix"]/div[position()>1 and not(@style)]//a'
target_div_xpath_str = '//div[@class="xrld-con clearfix"]'
# # 研究方向
