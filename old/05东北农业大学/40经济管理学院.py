...
school_id = 5
college_id = 40
start_urls = ['https://jjglxy.neau.edu.cn/xksz/szdw.htm']

a_s_xpath_str = '//div[@class="szdw_jscf"]/div[@class="szdw_dl"]/ul/li/a[@href]'
target_div_xpath_str = '//div[@class="xiangxifjz"]'
# # 研究方向
