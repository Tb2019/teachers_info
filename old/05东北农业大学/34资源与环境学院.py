...
school_name = '东北农业大学'
college_name = '资源与环境学院'
school_id = 5
college_id = 34
start_urls = ['https://zhxy.neau.edu.cn/szdw/zrjs/js.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/js/2.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/js/1.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/fjs.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/fjs/3.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/fjs/2.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/fjs/1.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/js1.htm',
              'https://zhxy.neau.edu.cn/szdw/zrjs/js1/1.htm']

a_s_xpath_str = '//div[@class="lm-right clearfix"]/div[@class="teach-top wow fadeInUp"]/div[@class="teacher-name"]/a'
target_div_xpath_str = '//div[@class="c-content"]'
# # 研究方向
