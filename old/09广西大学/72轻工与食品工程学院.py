...
school_name = '广西大学'
college_name = '轻工与食品工程学院'
school_id = 9
college_id = 72
base_url = 'https://prof.gxu.edu.cn/backend/openapi/openSearch/findByCondition?dwlx=2&dwh=30500&xm=&xkml=&yjxk=&dslx=&firstLetter=&pageNum={pagenum}&pageSize=12'
start_urls = [base_url.format(pagenum=pagenum+1) for pagenum in range(9)]
