...
school_name = '广西大学'
college_name = '新闻与传播学院'
school_id = 9
college_id = 81
base_url = 'https://prof.gxu.edu.cn/backend/openapi/openSearch/findByCondition?dwlx=2&dwh=32000&xm=&xkml=&yjxk=&dslx=&firstLetter=&pageNum={pagenum}&pageSize=12'
start_urls = [base_url.format(pagenum=pagenum+1) for pagenum in range(5)]
