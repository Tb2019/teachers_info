...
a_s_xpath_str = '//div[@class="views-teacher item-list"]/ul//a[@href!="#"]'
target_div_xpath_str = '//article//div[@class="inner"]/div[@class="row" and position()>1]'
