...
school_id = 105
college_id = 133
start_urls = [f'https://life.fudan.edu.cn/28175/list{i+1}.htm' for i in range(14)]

a_s_xpath_str = '//div[@id="wp_news_w6"]//a[@href!="#"]'
...
class SpecialSpider(ReCrawler):
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            ...
            if name:
                name = ''.join(name)
                if not re.match(r'[A-Za-z\sé-]*$', name, re.S):  # 中文名替换空格
        ...
        # if not self.api:  # 不使用第三方api解析
            ...
            if self.phone_xpath:
                ...
                try:
                    ...
                    if len(phone_list) > 1:
                        if '1196-12012006' in phone_list:
                            phone_list.remove('1196-12012006')
                        elif '505-5062016' in phone_list:
                            phone_list.remove('505-5062016')
                        elif '19391900400' in phone_list:
                            phone_list.remove('19391900400')
            ...
            if self.email_xpath:
                ...
                try:
                    ...
                    if len(email_list) > 1:
                        ...
                        email = re.sub(r'Officeloc@ion', '', email)
                        email = re.sub(r'OfficeAddress', '', email)
                    else:
                        email = email_list[0]
