...
school_name = '华东师范大学'
college_name = '通信与电子工程学院'
school_id = 91
college_id = 393
img_url_head = None
partition_num = '021'
start_urls = [
                'http://www.cee.ecnu.edu.cn/txgcx/list.htm',
                'http://www.cee.ecnu.edu.cn/dzgcx/list.htm',
                'http://www.cee.ecnu.edu.cn/syzx/list.htm',
                'http://www.cee.ecnu.edu.cn/yb/list.htm'
              ]

a_s_xpath_str = '/html/body/div[6]/div/div/div[2]/div/div[2]/div/div/div/div/div/div/table/tbody//td[1]//a'
