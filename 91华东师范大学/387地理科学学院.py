...
partition_num = '021'
start_urls = [
                'https://geo.ecnu.edu.cn/zcjb/list.htm'
              ]

a_s_xpath_str = '//ul[@class="wp_subcolumn_list"]//ul/li//a'
# a_s_xpath_str = '//*[@id="l-container"]/div/div/div[2]/div/div[2]/div/div/ul[1]/li/ul/li[33]/div/div/a'
