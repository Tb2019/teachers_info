...
school_name = '华东师范大学'
college_name = '生态与环境科学学院'
school_id = 91
college_id = 388
img_url_head = None
partition_num = '021'
start_urls = [
                'https://sees.ecnu.edu.cn/stx/list.htm',
                'https://sees.ecnu.edu.cn/stx/list2.htm',
                'https://sees.ecnu.edu.cn/stx/list3.htm',
                'https://sees.ecnu.edu.cn/hjkx/list.htm',
                'https://sees.ecnu.edu.cn/hjkx/list2.htm',
                'https://sees.ecnu.edu.cn/hjgc/list.htm',
                'https://sees.ecnu.edu.cn/zzkyry/list.htm',
              ]

a_s_xpath_str = '/html/body/div[5]/div/div/div[2]//div//li//div//a'
