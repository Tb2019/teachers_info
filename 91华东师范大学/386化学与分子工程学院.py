...
school_name = '华东师范大学'
college_name = '化学与分子工程学院'
school_id = 91
college_id = 386
img_url_head = None
partition_num = '021'
start_urls = [
                'https://chem.ecnu.edu.cn/26591/list.htm',
                'https://chem.ecnu.edu.cn/26592/list.htm',
                'https://chem.ecnu.edu.cn/26593/list.htm',
                'https://chem.ecnu.edu.cn/26594/list.htm',
                'https://chem.ecnu.edu.cn/26595/list.htm',
                'https://chem.ecnu.edu.cn/26596/list.htm'
              ]

a_s_xpath_str = '/html/body/div[2]/div/div[2]/div/div[3]/div/div[2]/div[2]/ul//li//div//a'
