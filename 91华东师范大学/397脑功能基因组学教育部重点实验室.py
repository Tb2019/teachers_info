...
school_name = '华东师范大学'
college_name = '脑功能基因组学教育部重点实验室'
school_id = 91
college_id = 397
img_url_head = None
partition_num = '021'
start_urls = [
                'https://sbg.ecnu.edu.cn/32408/list.htm',
                'https://sbg.ecnu.edu.cn/32408/list2.htm',
                'https://sbg.ecnu.edu.cn/32409/list.htm',
                'https://sbg.ecnu.edu.cn/1492/list.htm'
              ]

a_s_xpath_str = '/html/body/div[3]/div/div/div[2]/div[3]/div/div[1]/table/tbody//a'
