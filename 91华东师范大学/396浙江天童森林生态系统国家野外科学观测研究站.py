...
school_name = '华东师范大学'
college_name = '浙江天童森林生态系统国家野外科学观测研究站'
school_id = 91
college_id = 396
img_url_head = None
partition_num = '021'
start_urls = [
                'https://tiantong.ecnu.edu.cn/teacher/gdry',
                'https://tiantong.ecnu.edu.cn/teacher/gdry/2',
                'https://tiantong.ecnu.edu.cn/teacher/gdry/3',
                'https://tiantong.ecnu.edu.cn/teacher/gdry/4',
                'https://tiantong.ecnu.edu.cn/teacher/jzry  ',
                'https://tiantong.ecnu.edu.cn/teacher/zrkyry',
              ]

a_s_xpath_str = '/html/body/div[4]/div/div/div[2]/div[2]/div/div[1]/ul//a'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./div[@class="text"]/div[@class="h3"]/text()')
            if name:
                name = ''.join(name)
