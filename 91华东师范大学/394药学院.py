...
partition_num = '021'
start_urls = [
                'https://pharm.ecnu.edu.cn/bsyjsdsw2024nsgzsw/list.htm',
                'https://pharm.ecnu.edu.cn/ssyjsdsw2024nsgzsw/list.htm',
                'https://pharm.ecnu.edu.cn/sswbsyjsxyds/list.htm',
              ]

a_s_xpath_str = '//div[@id="wp_content_w6_0"]/table//a'
