...
partition_num = '021'
start_urls = [
                'https://math.ecnu.edu.cn/faculty.html',
                'https://math.ecnu.edu.cn/faculty.html?type=bsh',
              ]

a_s_xpath_str = '/html/body/div[2]/div[2]/div[2]/div[3]/table/tbody//a'
target_div_xpath_str = '//div[@class="con-body"]'
