...
partition_num = '021'
start_urls = [
                'https://history.ecnu.edu.cn/33444/list.htm',
                'https://history.ecnu.edu.cn/jzjs/list.htm'
              ]

a_s_xpath_str = '//div[@id="wp_news_w7"]//div[@class="row"]/div//a'
target_div_xpath_str = '//div[@class="main-right col-lg-9 col-md-9 col-sm-12 col-xs-12"]'
