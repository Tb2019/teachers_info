...
school_name = '华东师范大学'
college_name = '极化材料与器件教育部重点实验室'
school_id = 91
college_id = 398
img_url_head = None
partition_num = '021'
start_urls = [
                'https://clpm.ecnu.edu.cn/35/98/c30955a341400/page.htm',
                'https://clpm.ecnu.edu.cn/35/97/c30955a341399/page.htm',
              ]

a_s_xpath_str = '//div[@class="wp_articlecontent"]/p//a'
