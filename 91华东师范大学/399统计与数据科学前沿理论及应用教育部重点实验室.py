...
school_name = '华东师范大学'
college_name = '统计与数据科学前沿理论及应用教育部重点实验室'
school_id = 91
college_id = 399
img_url_head = None
partition_num = '021'
start_urls = [
                'https://klatasds.ecnu.edu.cn/yjtd/list.htm'
              ]

a_s_xpath_str = '/html/body/div[3]/div/div/div[2]/div/div[2]/div/div/div/div/div/div//a'
