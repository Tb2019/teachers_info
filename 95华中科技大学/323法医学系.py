...
partition_num = '027'
start_urls = [
                'http://fayixi.tjmu.edu.cn/szdw/js.htm',
                'http://fayixi.tjmu.edu.cn/szdw/fjs.htm',
                'http://fayixi.tjmu.edu.cn/szdw/js1.htm',
              ]

a_s_xpath_str = '/html/body/div[2]/div[2]/ul/li/p/a'
