...
school_name = '华中科技大学'
college_name = '生殖健康研究所(原计划生育研究所)'
school_id = 95
college_id = 348
img_url_head = None
partition_num = '027'
start_urls = [
                'https://irh.hust.edu.cn/szdw/js.htm',
                'https://irh.hust.edu.cn/szdw/kzjs.htm',
                'https://irh.hust.edu.cn/szdw/fjs.htm',
              ]

a_s_xpath_str = '/html/body/div[4]/div/div[2]/div[3]/ul/li/a'
