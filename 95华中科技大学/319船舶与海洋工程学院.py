...
school_name = '华中科技大学'
college_name = '船舶与海洋工程学院'
school_id = 95
college_id = 319
img_url_head = None
partition_num = '027'
start_urls = [
                # 'http://ch.hust.edu.cn/szdw/jsml1.htm',
                'https://ch.hust.edu.cn/szdw/syy.htm',
                # '',
                # ''
              ]

# a_s_xpath_str = '/html/body/div[7]/div[2]/div[3]/div/div/ul/li/a'
a_s_xpath_str = '//ul[@class="jiao_list"]/li/a'
target_div_xpath_str = '//div[@class="conbox" or @class="dft-main clearfix" or @class="content"]|//body'
