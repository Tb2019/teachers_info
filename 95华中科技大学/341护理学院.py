...
partition_num = '027'
start_urls = [
                'http://huli.tjmu.edu.cn/szdw/msfc.htm',
                'http://huli.tjmu.edu.cn/szdw/msfc/3.htm',
                'http://huli.tjmu.edu.cn/szdw/msfc/2.htm',
                'http://huli.tjmu.edu.cn/szdw/msfc/1.htm'
              ]

a_s_xpath_str = '//div[@class="articleList01"]//li/a'
