...
school_name = '华中科技大学'
college_name = '医药卫生管理学院'
school_id = 95
college_id = 357
img_url_head = None
partition_num = '027'
start_urls = [
                'http://mms.tjmu.edu.cn/szll1/jsml1/wsglx.htm',
                'http://mms.tjmu.edu.cn/szll1/jsml1/xxglx.htm',
                'http://mms.tjmu.edu.cn/szll1/jsml1/yjzx.htm',
                'http://mms.tjmu.edu.cn/szll1/jsml1/fsjg.htm'
              ]

a_s_xpath_str = '/html/body/div[5]/div/div[2]/div/div/ul/li/a'
