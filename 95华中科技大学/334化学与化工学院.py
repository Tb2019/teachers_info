...
partition_num = '027'
start_urls = [
                'https://chem.hust.edu.cn/szdw2.htm'
              ]

a_s_xpath_str = '/html/body/div/div[3]/div[2]/div[2]/div/ol/li/a'
target_div_xpath_str = '//div[@class="main" or @class="dft-main clearfix" or @class="introbox clearfix" or @class="conbox"]|//form[@name="_newscontent_fromname"]|//body'
