...
partition_num = '027'
start_urls = [
                'http://cse.hust.edu.cn/szdw/wlkjaqx.htm',
                'http://cse.hust.edu.cn/szdw/xxaqx.htm',
                'http://cse.hust.edu.cn/szdw/mmkxyjsx.htm',
                'http://cse.hust.edu.cn/szdw/jcxkpt.htm'
              ]

a_s_xpath_str = '/html/body/main/section/div/div/div[2]/div[3]/div/dl/dd/ul/li/a'
