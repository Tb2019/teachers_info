...
partition_num = '022'
start_urls = [
                'https://env.nankai.edu.cn/14180/list.htm',
                'https://env.nankai.edu.cn/14181/list.htm',
                'https://env.nankai.edu.cn/14182/list.htm',
                'https://env.nankai.edu.cn/14183/list.htm',
              ]

a_s_xpath_str = '/html/body/div/div[3]/div/div[2]/div[2]/div/div[1]/table/tbody//a'
target_div_xpath_str = '//div[@class="entry"]'
