...
partition_num = '022'
start_urls = [
                'https://pharmacy.nankai.edu.cn/szdw/js.htm',
                'https://pharmacy.nankai.edu.cn/szdw/js/1.htm',
                'https://pharmacy.nankai.edu.cn/szdw/fjs.htm',
                'https://pharmacy.nankai.edu.cn/szdw/js1.htm',
                'https://pharmacy.nankai.edu.cn/szdw/syjsry.htm',
                'https://pharmacy.nankai.edu.cn/szdw/dzglry.htm',
              ]

a_s_xpath_str = '/html/body/form/div[2]/div[5]/div[1]/div[1]/ul//a'
target_div_xpath_str = '//div[@class="contentDiv"]'
