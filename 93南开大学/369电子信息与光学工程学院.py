...
school_name = '南开大学'
college_name = '电子信息与光学工程学院'
school_id = 93
college_id = 369
img_url_head = None
partition_num = '022'
start_urls = [
                'https://ceo.nankai.edu.cn/szll/xdgxyjs.htm',
                'https://ceo.nankai.edu.cn/szll/gdzbmqjyjsyjs.htm',
                'https://ceo.nankai.edu.cn/szll/wdzgcx.htm',
                'https://ceo.nankai.edu.cn/szll/dzkxygcx.htm',
                'https://ceo.nankai.edu.cn/szll/dzxxgcx.htm',
                'https://ceo.nankai.edu.cn/szll/txgcx.htm',
                'https://ceo.nankai.edu.cn/szll/dzxxsyjxzx.htm'
              ]

a_s_xpath_str = '/html/body/div[5]/div[2]/div/table/tbody//a'
target_div_xpath_str = '//div[@class="detailContent"]'
