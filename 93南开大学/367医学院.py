...
partition_num = '022'
start_urls = [
                'https://medical.nankai.edu.cn/ys/list.htm',
                'https://medical.nankai.edu.cn/6612/list.htm',
                ...
                'https://medical.nankai.edu.cn/tjszlyy/list.htm',
              ]

a_s_xpath_str = '//div[@class="teacher-list"]//a'
