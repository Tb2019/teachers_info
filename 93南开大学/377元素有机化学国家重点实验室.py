...
school_name = '南开大学'
college_name = '元素有机化学国家重点实验室'
school_id = 93
college_id = 377
img_url_head = None
partition_num = '022'
start_urls = [
                'http://skleoc.nankai.edu.cn/yjdw1/xsdtr.htm',
                'http://skleoc.nankai.edu.cn/yjdw1/xsdtr/1.htm',
                'http://skleoc.nankai.edu.cn/yjdw1/ggyjry.htm',
                'http://skleoc.nankai.edu.cn/yjdw1/ggyjry/2.htm',
                'http://skleoc.nankai.edu.cn/yjdw1/ggyjry/1.htm',
                'http://skleoc.nankai.edu.cn/yjdw1/tpyjy.htm',
                'http://skleoc.nankai.edu.cn/yjdw1/kzjs.htm'
              ]

a_s_xpath_str = '//div[@class="publish"]//li'
